...
[assembly: InternalsVisibleTo("Sisus.HierarchyFolders.Editor")]
...
namespace Sisus.HierarchyFolders
{
	...
	public sealed class HierarchyFolder : MonoBehaviour
	{
		...
		internal static readonly Dictionary<int, HierarchyFolderInfo> infos = new();
		...
		private void OnDestroy()
		{
			...
			infos.Remove(gameObject.GetInstanceID());
