...
namespace Sisus.HierarchyFolders
{
	...
	public class HierarchyFolderEditorTool : EditorTool
	{
		...
		{
			icon = new(HierarchyFolderPreferences.Get().GetDefaultIcon(18).closed, "Create Hierarchy Folder");
		...
		private void OnActivate()
		{
			...
			var window = HierarchyWindowUtility.LastInteractedHierarchyWindow;
			if(window)
			{
				window.Focus();
